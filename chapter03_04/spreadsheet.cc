...
QString
SpreadSheet::currentFormula() const
{
...
SpreadSheet::selectedRange() const
{
...
bool 
SpreadSheet::readFile(const QString &fileName)
{
  QFile file(fileName);
...
bool
SpreadSheet::writeFile(const QString &fileName)
{
  QFile file(fileName);
